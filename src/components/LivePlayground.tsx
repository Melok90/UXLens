...
import { Sliders, RotateCcw, Palette, Type, ChevronDown, ChevronUp, AlignLeft, AlignRight } from 'lucide-react';
...
export default function LivePlayground() {
  ...
  return (
    <section className="bg-white/80 dark:bg-[#101114]/90 border border-zinc-200 dark:border-zinc-800/90 rounded-xl p-4 shadow-xs linear-card backdrop-blur-xs flex flex-col gap-3 transition-all">
      {/* Header Bar */}
      <div className="flex items-center justify-between flex-wrap gap-2">
        <div className="flex items-center gap-2.5">
          <div className="w-7 h-7 rounded-lg bg-[#5e6ad2]/10 flex items-center justify-center text-[#5e6ad2] font-bold">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-mono font-medium px-2 py-0.5 rounded-full border border-[#5e6ad2]/30 bg-[#5e6ad2]/5 dark:bg-[#5e6ad2]/10 text-[#5e6ad2] dark:text-[#828cf5]">
                {t('playground.badge')}
              </span>
              {hasOverrides && (
                <span className="text-[10px] font-mono px-1.5 py-0.2 rounded bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/20 font-semibold animate-pulse">
        ...
        <div className="flex items-center gap-2">
          {hasOverrides && (
            <button
              ...
              className="px-2.5 py-1 text-xs font-medium text-zinc-600 dark:text-zinc-400 hover:text-rose-600 dark:hover:text-rose-400 border border-zinc-200 dark:border-zinc-800 hover:border-rose-300 dark:hover:border-rose-800 rounded-md transition-colors flex items-center gap-1.5 cursor-pointer shadow-2xs"
            >
      ...
      <AnimatePresence initial={false}>
        {isOpen && (
          <motion.div
            ...
            className="grid grid-cols-1 lg:grid-cols-12 gap-3 pt-2 border-t border-zinc-100 dark:border-zinc-850"
          >
            ...
            <div className="lg:col-span-7 flex flex-col gap-1.5">
              ...
              <div className="flex items-center bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg px-3 py-1.5 focus-within:border-[#5e6ad2] focus-within:ring-2 focus-within:ring-[#5e6ad2]/20 transition-all">
                <input
                  type="text"
                  value={customText}
              ...
              <div className="flex items-center gap-1.5 flex-wrap pt-0.5">
                ...
                {presets.map((p, idx) => (
                  <button
                    ...
                    className={`text-[10px] px-2 py-0.5 rounded border transition-all cursor-pointer font-medium ${
                      customText === p.value
            ...
            <div className="lg:col-span-5 flex flex-col gap-1.5">
              ...
              <div className="flex items-center gap-2">
                ...
                <label className="relative w-8 h-8 rounded-lg border border-zinc-200 dark:border-zinc-700 overflow-hidden shrink-0 cursor-pointer shadow-2xs flex items-center justify-center hover:scale-105 transition-transform">
                  <span
                ...
                {/* HEX Text input */}
                <div className="flex-1 flex items-center bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg px-2.5 py-1.5 focus-within:border-[#5e6ad2] focus-within:ring-2 focus-within:ring-[#5e6ad2]/20 transition-all font-mono text-xs">
                  <input
                    type="text"
                ...
                <div className="inline-flex bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg p-0.5 shrink-0">
                  <button
                    type="button"
