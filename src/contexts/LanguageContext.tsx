...
const translations: Translations = {
  ru: {
    ...
    "proModal.badge": "ПРЕМИАЛЬНЫЙ ТАРИФ",
    "proModal.title": "UX Lens PRO",
    "proModal.subtitle": "Инструменты профессионального тестирования и внедрения дизайн-систем",
    "proModal.price": "990 ₽ / месяц",
    "proModal.priceSub": "или $12 / mo при ежемесячной оплате",
    "proModal.f1": "Live Playground: кастомный текст и стресс-тесты переполнения строк",
    "proModal.f2": "Brand HEX Overrides: мгновенная примерка фирменного цвета бренда",
    "proModal.f3": "RTL-тестирование для арабского языка и иврита",
    "proModal.f4": "Полный экспорт Design Tokens в JSON, CSS Variables и Tailwind",
    "proModal.f5": "Инспектор анатомии компонентов с замером Touch Targets",
    "proModal.cta": "Активировать PRO доступ",
  ...
  en: {
    ...
    "proModal.badge": "PREMIUM PLAN",
    "proModal.title": "UX Lens PRO",
    "proModal.subtitle": "Professional tools for testing and integrating design systems",
    "proModal.price": "$12 / month",
    "proModal.priceSub": "Billed monthly • Cancel anytime",
    "proModal.f1": "Live Playground: custom copy and container truncation stress tests",
    "proModal.f2": "Brand HEX Overrides: instant brand color propagation across 8 systems",
    "proModal.f3": "RTL internationalization testing for Arabic & Hebrew",
    "proModal.f4": "Full Design Tokens export to JSON, CSS Variables & Tailwind",
    "proModal.f5": "Component Anatomy Inspector with Touch Target measurements",
    "proModal.cta": "Activate PRO Access",
